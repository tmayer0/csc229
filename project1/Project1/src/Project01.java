...
public class Project01 {
    ...
    percentProjects = sumProjects / 700.0;
    ...
    JOptionPane.showMessageDialog(null,
            ...
            "___________________________" + "\n" +
            "   % Grade from Projects   ----  " + (int)(percentProjects * 100) + "%" + "\n" +
            "   % Grade from Homework   ----  " + (int)(percentHw * 100) + "%" + "\n" +
            "   % Grade from Tests   ----  " + (int)(percentTests * 100) + "%" + "\n" +
            "   % Class Attendance   ----  " + (int)(att/28 * 100) + "%" + "\n" +
            "===========================" + "\n" +
            "   Percentage for Class   ----  " + (int)(percentAll) + "%" + "\n" +
            "==========================="
            , "Project 1 - Seyed",
